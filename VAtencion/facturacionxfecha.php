        ...
        $css->CrearForm2("FrmFecha", "ProcesadoresJS/GeneradorCSV.php", "post", "_blank");
            ...
            $css->FilaTabla(16);
                print("<td style='text-align:center'>");
                   $css->CrearInputText("TxtFechaIni", "date", "", date("Y-m-d"), "Fecha Inicial", "Black", "", "", 100, 30, 0, 1);
                print("</td>");
                print("<td style='text-align:center'>");
                   $css->CrearInputText("TxtFechaFin", "date", "", date("Y-m-d"), "Fecha Inicial", "Black", "", "", 100, 30, 0, 1);
                print("</td>");
                print("<td style='text-align:center'>");
