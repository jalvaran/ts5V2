/**
 * Controlador para realizar las Ordenes de compras
...
/*
 * Abre el modal para registrar la nueva Orden
 * @returns {undefined}
 */
function AbrirModalNuevaCompra(Proceso="Nuevo"){
    ...
    var form_data = new FormData();
        ...
        $.ajax({
        url: './Consultas/OrdenCompra.draw.php',
        //dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
        ...
        success: function(data){
            ...
            $('#CmbTerceroCrearCompra').select2({
                ...
                ajax: {
                  url: 'buscadores/proveedoresxid.search.php',
                  dataType: 'json',
                  delay: 250,
...
function CrearCompra(){
    ...
    var TxtCondiciones = document.getElementById('TxtCondiciones').value;
    var TxtSolicitante = document.getElementById('TxtSolicitante').value;
    var TxtNumCotizacion = document.getElementById('TxtNumCotizacion').value;
    ...
    var form_data = new FormData();
        ...
        form_data.append('PlazoEntrega', PlazoEntrega);
        form_data.append('Concepto', Concepto);
        form_data.append('TxtCondiciones', TxtCondiciones);
        form_data.append('TxtSolicitante', TxtSolicitante);
        form_data.append('TxtNumCotizacion', TxtNumCotizacion);
        ...
        success: function(data){
          ...
          if (respuestas[0] == "OK") { 
              if(Accion==1){
                ...
                alertify.success("Orden de Compra "+idCompra+" creada");
                var x = document.getElementById("idCompra");
                  var option = document.createElement("option");
                  option.text = idCompra+" "+Concepto;
              ...
              if(Accion==2){
                  ...
                  var TextoOpcion=idCompraActiva+" "+respuestas[1]+" "+respuestas[2];
                  document.getElementById("idCompra").options[index].text=TextoOpcion;
                  alertify.success("Orden de Compra "+idCompraActiva+" Editada");
              }
          
          }else{
              alertify.error("Error al crear la Orden de compra");
